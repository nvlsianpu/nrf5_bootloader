...
#ifdef WDT_DFU
static void wdt_timers_start(void);
#endif
...
APP_TIMER_DEF(m_wd_feed_timer_id);                                  /**< Application timer id. */

#define WD_FEED_INTERVAL  APP_TIMER_TICKS(250, APP_TIMER_PRESCALER)
static void wdt_timers_start(void)
{
    uint32_t err_code;
    ...
    err_code = app_timer_create(&m_wd_feed_timer_id,
                                APP_TIMER_MODE_REPEATED,
                                wd_feed_timeout_handler);
    APP_ERROR_CHECK(err_code);
